VERSION = '3.0.5'FILE_RECORD_IN_USE = 0x0001
FILE_RECORD_IS_DIRECTORY = 0x0002
FILE_RECORD_IS_EXTENSION = 0x0004
FILE_RECORD_HAS_SPECIAL_INDEX = 0x0008STANDARD_INFORMATION_ATTRIBUTE = 0x10
...
EA_ATTRIBUTE = 0xE0
LOGGED_UTILITY_STREAM_ATTRIBUTE = 0x100ATTRIBUTE_NAMES = {
...
INDEX_ENTRY_END = 0x02MFT_RECORD_SIZE = 1024ATTR_FLAG_COMPRESSED = 0x0001
ATTR_FLAG_ENCRYPTED = 0x4000
ATTR_FLAG_SPARSE = 0x8000COLLATION_BINARY = 0x00
COLLATION_FILENAME = 0x01
COLLATION_UNICODE = 0x02
COLLATION_ULONG = 0x10
COLLATION_SID = 0x11
COLLATION_SECURITY_HASH = 0x12
COLLATION_ULONGS = 0x13BYTE_ORDER = 'little'STRUCT_STANDARD_INFORMATION = '<QQQQLLLQQQ'
STRUCT_FILE_NAME = '<QQQQQQLLLLBB'
STRUCT_OBJECT_ID = '<16s16s16s16s'MFT_RECORD_MAGIC_NUMBER_OFFSET = 0
...
MFT_RECORD_RECORD_NUMBER_OFFSET = 44MFT_RECORD_MAGIC_NUMBER_SIZE = 4
...
MFT_RECORD_RECORD_NUMBER_SIZE = 4MFT_RECORD_MAGIC = b'FILE'

CSV_HEADER = [    'Record Number', 
    'Record Status',    'Record Type',    'File Type',    'Sequence Number',
    'Parent Record Number',
    'Parent Record Sequence Number',    'Filename',
    'Filepath',    'SI Creation Time',
    'SI Modification Time',
    'SI Access Time',
    'SI Entry Time',    'FN Creation Time',
    'FN Modification Time',
    'FN Access Time',
    'FN Entry Time',    'Object ID',
    'Birth Volume ID',
    'Birth Object ID',
    'Birth Domain ID',    'Has Standard Information',
    'Has Attribute List',
    'Has File Name',
    'Has Volume Name',
    ...
    'Has EA Information',
    'Has EA',
    'Has Logged Utility Stream',    'Attribute List Details',
    'Security Descriptor',
    'Volume Name',
    'Volume Information',
    'Data Attribute',
